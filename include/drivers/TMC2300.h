...
#define TMC2300_T120_MASK 0x100 // DRV_STATUS // 120锟紺 comparator
#define TMC2300_T120_SHIFT 8 // 120锟紺 comparator
#define TMC2300_T143_MASK 0x200 // DRV_STATUS // 143锟紺 comparator
#define TMC2300_T143_SHIFT 9 // 143锟紺 comparator
#define TMC2300_T150_MASK 0x400 // DRV_STATUS // 150锟紺 comparator
#define TMC2300_T150_SHIFT 10 // 150锟紺 comparator
#define TMC2300_T157_MASK 0x800 // DRV_STATUS // 157锟紺 comparator
#define TMC2300_T157_SHIFT 11 // 157锟紺 comparator
...
private:
  ...
  // CRC8-ATM计算函数（多项式: 0x07, 初始值: 0x00）
  uint8_t calculateCRC(uint8_t *data, uint8_t length);

public:
  TMC2300(HardwareSerial *ser, uint8_t address);
